    ...
    <div class="card admin-sidebar-card">
        ...
        <div class="card-body p-2 admin-sidebar-menu">
            <ul class="nav flex-column admin-sidebar-nav">
                <li class="nav-item">
                    <a class="nav-link <?php echo $page_class === 'dashboard' ? 'active' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $page_class === 'shop' ? 'active' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $page_class === 'gm_cmd' ? 'active' : ''; ?>"
                ...
                <li class="nav-item">
                    <?php
                    $settings_pages = ['settings', 'general', 'smtp', 'recaptcha', 'realm', 'soap', 'vote-sites', 'vote_sites', 'page_manager'];
                    ?>
                    <a class="nav-link <?php echo in_array($page_class, $settings_pages) ? 'active' : ''; ?>"
