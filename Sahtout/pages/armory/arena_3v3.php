            ...
            <div class="table-container tw-overflow-x-auto tw-rounded-lg tw-shadow-lg">
                <table class="tw-w-full tw-text-sm tw-text-center tw-bg-gray-800">
                    <thead class="tw-bg-gray-700 tw-text-amber-400 tw-uppercase">
                        <tr>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_rank', 'Rank'); ?></th>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_name', 'Name'); ?></th>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_faction', 'Faction'); ?></th>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_wins', 'Wins'); ?></th>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_losses', 'Losses'); ?></th>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_winrate', 'Winrate'); ?></th>
                            <th class="tw-py-3 tw-px-6"><?php echo translate('arena_3v3_rating', 'Rating'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
