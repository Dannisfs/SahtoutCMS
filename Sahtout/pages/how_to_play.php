...
if (file_exists($realmsFile)) {
    ...
    // Priority: Admin Config > Realm Config > Default
    if (isset($server_realmlist) && !empty($server_realmlist)) {
        $realmlistIP = $server_realmlist;
    } elseif (!empty($realmlist[0]['address'])) {
        $realmlistIP = $realmlist[0]['address'];
    }
} elseif (isset($server_realmlist) && !empty($server_realmlist)) {
    $realmlistIP = $server_realmlist;
}
?>
        ...
        <div class="step">
            <div class="step-content">
                <div class="step-text">
                    ...
                    <a class="btn"
                        href="<?php echo $base_path; ?>register"><?php echo translate('create_account', 'Create Account'); ?></a>
                </div>
                <img src="<?php echo $base_path; ?>img/howtoplay/down_register.jpg"
        ...
        <div class="step">
            <div class="step-content">
                <div class="step-text">
                    ...
                    <p><?php echo translate('step_2_desc', 'You need World of Warcraft: Wrath of the Lich King (3.3.5a). Choose your preferred download method:'); ?>
                    </p>
                    <div class="download-options">
                        <a class="btn btn-primary"
                            href="<?php echo $base_path; ?>download/"><?php echo translate('direct_download', 'Direct Download'); ?></a>
                        <a class="btn btn-secondary"
                            href="<?php echo $base_path; ?>download"><?php echo translate('torrent_download', 'Torrent Download'); ?></a>
                    </div>
                    <p><small><?php echo translate('download_note', 'Direct downloads are faster for most users, while torrents may be more reliable for slower connections.'); ?></small>
                    </p>
                </div>
                <img src="<?php echo $base_path; ?>img/howtoplay/down_download.png"
        ...
        <div class="step">
            <div class="step-content">
                <div class="step-text">
                    ...
                    <p><?php echo translate('step_3_desc_1', 'Open your World of Warcraft folder, go to <code><strong>Data/enUS</strong></code> or <code><strong>Data/enGB</strong></code>, and find <code>realmlist.wtf</code>.'); ?>
                    </p>
                    <p><?php echo translate('step_3_desc_2', 'Open it with Notepad and replace everything inside with:'); ?>
                    </p>
                ...
                <img id="down_img_realm" src="<?php echo $base_path; ?>img/howtoplay/down_realmlist.png"
        ...
        <div class="step">
            <div class="step-content">
                <div class="step-text">
                    ...
                    <p><?php echo translate('step_4_desc_1', 'Open <code>Wow.exe</code> (not Launcher.exe) and log in using your account credentials.'); ?>
                    </p>
                    <p><?php echo translate('step_4_desc_2', 'Enjoy your adventure on our server!'); ?></p>
                </div>
                <img src="<?php echo $base_path; ?>img/howtoplay/down_wow.png"
