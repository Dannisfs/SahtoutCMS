                ...
                <div class="col-md-10">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">
                                <?php echo translate('admin_shop_add_edit_header', 'Add/Edit Shop Item'); ?>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <select name="category" id="category" class="form-select" required>
                                            <option value="Mount">
                                                <?php echo translate('admin_shop_category_mount', 'Mount'); ?>
                                            </option>
                                            <option value="Pet">
                                                <?php echo translate('admin_shop_category_pet', 'Pet'); ?>
                                            </option>
                                            <option value="Gold">
                                                <?php echo translate('admin_shop_category_gold', 'Gold'); ?>
                                            </option>
                                            <option value="Service">
                                                <?php echo translate('admin_shop_category_service', 'Service'); ?>
                                            </option>
                                            <option value="Stuff">
                                                <?php echo translate('admin_shop_category_stuff', 'Stuff'); ?>
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group at-login-flags-group">
                                        ...
                                        <select name="at_login_flags" id="at_login_flags" class="form-select">
                                            <option value="0">
                                                <?php echo translate('admin_shop_at_login_none', 'None'); ?>
                                            </option>
                                            <option value="1">
