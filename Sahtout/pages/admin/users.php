...
<head>
    ...
    <meta name="description"
        content="<?php echo translate('admin_users_meta_description', 'User Management for Sahtout WoW Server'); ?>">
                ...
                <div class="col-md-10">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <?php echo translate('admin_users_search_header', 'Search & Filter'); ?>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <input type="text" name="search_username" class="form-control"
                                            placeholder="<?php echo translate('admin_users_search_username_placeholder', 'Search by username'); ?>"
                                            value="<?php echo htmlspecialchars($search_username); ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" name="search_email" class="form-control"
                                            placeholder="<?php echo translate('admin_users_search_email_placeholder', 'Search by email'); ?>"
                                    ...
                                    <div class="col-md-4">
                                        <select name="role_filter" class="form-select">
                                            <option value="" <?php echo $role_filter === '' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_all_roles', 'All Roles'); ?>
                                            </option>
                                            <option value="player" <?php echo $role_filter === 'player' ? 'selected' : ''; ?>><?php echo translate('admin_users_role_player', 'Player'); ?>
                                            </option>
                                            <option value="moderator" <?php echo $role_filter === 'moderator' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_role_moderator', 'Moderator'); ?>
                                            </option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <select name="ban_filter" class="form-select">
                                            <option value="" <?php echo $ban_filter === '' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_all_accounts', 'All Accounts'); ?>
                                            </option>
                                    ...
                                    <div class="col-md-4">
                                        <select name="gmlevel_filter" class="form-select">
                                            <option value="" <?php echo $gmlevel_filter === '' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_all_gm_levels', 'All GM Levels'); ?>
                                            </option>
                                            <option value="player" <?php echo $gmlevel_filter === 'player' ? 'selected' : ''; ?>><?php echo translate('admin_users_gmlevel_player', 'Player'); ?>
                                            </option>
                                            <option value="1" <?php echo $gmlevel_filter === '1' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_gmlevel_1', 'GM Level 1'); ?>
                                            </option>
                                            <option value="2" <?php echo $gmlevel_filter === '2' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_gmlevel_2', 'GM Level 2'); ?>
                                            </option>
                                            <option value="3" <?php echo $gmlevel_filter === '3' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_gmlevel_3', 'GM Level 3'); ?>
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <select name="sort_id" class="form-select">
                                            <option value="asc" <?php echo $sort_id === 'asc' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_sort_id_asc', 'Sort by ID: Ascending'); ?>
                                            </option>
                                            <option value="desc" <?php echo $sort_id === 'desc' ? 'selected' : ''; ?>>
                                                <?php echo translate('admin_users_sort_id_desc', 'Sort by ID: Descending'); ?>
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary"
                                            type="submit"><?php echo translate('admin_users_apply_button', 'Apply'); ?></button>
                                    </div>
                                </div>
                                <input type="hidden" name="website_page"
                                    value="<?php echo htmlspecialchars($website_page); ?>">
                                <input type="hidden" name="ingame_page"
                                    value="<?php echo htmlspecialchars($ingame_page); ?>">
                            </form>
                        </div>
                    </div>
                    <!-- Tabs -->
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link <?php echo $active_tab === 'website' ? 'active' : ''; ?>"
                                href="#website-tab"
                                data-bs-toggle="tab"><?php echo translate('admin_users_tab_website', 'Website'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $active_tab === 'ingame' ? 'active' : ''; ?>"
                                href="#ingame-tab"
                                data-bs-toggle="tab"><?php echo translate('admin_users_tab_ingame', 'In-Game'); ?></a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <!-- Website Tab -->
                        <div class="tab-pane fade <?php echo $active_tab === 'website' ? 'show active' : ''; ?>"
                            id="website-tab">
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="table-wrapper">
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th><?php echo translate('admin_users_table_account_id', 'Account ID'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_username', 'Username'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_email', 'Email'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_avatar', 'Avatar'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_points', 'Points'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_tokens', 'Tokens'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_role', 'Role'); ?></th>
                                                    <th><?php echo translate('admin_users_table_last_updated', 'Last Updated'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_action', 'Action'); ?>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <?php else: ?>
                                                    <?php while ($user = $users_result->fetch_assoc()): ?>
                                                        <tr id="user-<?php echo $user['account_id']; ?>">
                                                            ...
                                                            <td><?php echo htmlspecialchars($user['email'] ?? translate('admin_users_email_not_set', 'Not set')); ?>
                                                            </td>
                                                            ...
                                                            <td><span
                                                                    class="status-<?php echo htmlspecialchars($user['role']); ?>">
                                                                    <?php echo ucfirst(translate('admin_users_role_' . $user['role'], ucfirst($user['role']))); ?>
                                                                </span></td>
                                                            <td><?php echo $user['last_updated'] ? date('M j, Y H:i', strtotime($user['last_updated'])) : translate('admin_users_never', 'Never'); ?>
                                                            </td>
                                                            <td>
                                                                <button class="btn btn-edit" data-bs-toggle="modal"
                                                                    data-bs-target="#editModal-<?php echo $user['account_id']; ?>"><?php echo translate('admin_users_edit_button', 'Edit'); ?></button>
                                                            </td>
                                                        </tr>
                                                        <!-- Edit Modal -->
                                                        <div class="modal fade"
                                                            id="editModal-<?php echo $user['account_id']; ?>" tabindex="-1"
                                                            aria-labelledby="editModalLabel-<?php echo $user['account_id']; ?>"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="editModalLabel-<?php echo $user['account_id']; ?>">
                                                                            <?php echo translate('admin_users_edit_modal_title', 'Edit User: ') . htmlspecialchars($user['username']); ?>
                                                                        </h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="<?php echo translate('admin_users_close_button', 'Close'); ?>"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form method="POST"
                                                                            action="<?php echo $base_path; ?>admin/users">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label"><?php echo translate('admin_users_label_username', 'Username'); ?></label>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label"><?php echo translate('admin_users_label_email', 'Email'); ?></label>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label"><?php echo translate('admin_users_label_points', 'Points'); ?></label>
                                                                                <input type="number" name="points"
                                                                                    class="form-control"
                                                                                    value="<?php echo htmlspecialchars($user['points']); ?>"
                                                                                    required>
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label"><?php echo translate('admin_users_label_tokens', 'Tokens'); ?></label>
                                                                                <input type="number" name="tokens"
                                                                                    class="form-control"
                                                                                    value="<?php echo htmlspecialchars($user['tokens']); ?>"
                                                                                    required>
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label"><?php echo translate('admin_users_label_role', 'Role'); ?></label>
                                                                                <select name="role" class="form-select">
                                                                                    <option value="player" <?php echo $user['role'] === 'player' ? 'selected' : ''; ?>>
                                                                                        <?php echo translate('admin_users_role_player', 'Player'); ?>
                                                                                    </option>
                                                                                    <option value="moderator" <?php echo $user['role'] === 'moderator' ? 'selected' : ''; ?>>
                                                                                        <?php echo translate('admin_users_role_moderator', 'Moderator'); ?>
                                                                                    </option>
                                                                                    <option value="admin" <?php echo $user['role'] === 'admin' ? 'selected' : ''; ?>>
                                                                                        <?php echo translate('admin_users_role_admin', 'Admin'); ?>
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary"
                                                                                    data-bs-dismiss="modal"><?php echo translate('admin_users_cancel_button', 'Cancel'); ?></button>
                                                                                <button type="submit"
                                                                                    class="btn btn-primary"><?php echo translate('admin_users_save_button', 'Save'); ?></button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                    ...
                                    <?php if ($total_website_pages > 1): ?>
                                        <div class="pagination-label">
                                            <?php echo translate('admin_users_website_pagination_label', 'Website Users Pagination'); ?>
                                        </div>
                                        <nav
                                            aria-label="<?php echo translate('admin_users_website_pagination_aria', 'Website users pagination'); ?>">
                                            <ul class="pagination">
                                                <li class="page-item <?php echo $website_page <= 1 ? 'disabled' : ''; ?>">
                                                    <a class="page-link"
                                                        href="<?php echo $base_path; ?>admin/users?<?php echo ($search_username ? 'search_username=' . urlencode($search_username) . '&' : '') . ($search_email ? 'search_email=' . urlencode($search_email) . '&' : '') . ($role_filter ? 'role_filter=' . urlencode($role_filter) . '&' : '') . ($ban_filter ? 'ban_filter=' . urlencode($ban_filter) . '&' : '') . ($gmlevel_filter ? 'gmlevel_filter=' . urlencode($gmlevel_filter) . '&' : '') . ($sort_id ? 'sort_id=' . urlencode($sort_id) . '&' : '') . 'website_page=' . ($website_page - 1) . '&ingame_page=' . $ingame_page; ?>"
                                                        aria-label="<?php echo translate('admin_users_previous', 'Previous'); ?>">
                                                ...
                                                <?php endfor; ?>
                                                <li
                                                    class="page-item <?php echo $website_page >= $total_website_pages ? 'disabled' : ''; ?>">
                                                    <a class="page-link"
                                                        href="<?php echo $base_path; ?>admin/users?<?php echo ($search_username ? 'search_username=' . urlencode($search_username) . '&' : '') . ($search_email ? 'search_email=' . urlencode($search_email) . '&' : '') . ($role_filter ? 'role_filter=' . urlencode($role_filter) . '&' : '') . ($ban_filter ? 'ban_filter=' . urlencode($ban_filter) . '&' : '') . ($gmlevel_filter ? 'gmlevel_filter=' . urlencode($gmlevel_filter) . '&' : '') . ($sort_id ? 'sort_id=' . urlencode($sort_id) . '&' : '') . 'website_page=' . ($website_page + 1) . '&ingame_page=' . $ingame_page; ?>"
                                                        aria-label="<?php echo translate('admin_users_next', 'Next'); ?>">
                        ...
                        <!-- In-Game Tab -->
                        <div class="tab-pane fade <?php echo $active_tab === 'ingame' ? 'show active' : ''; ?>"
                            id="ingame-tab">
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo translate('admin_users_table_join_date', 'Join Date'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_last_login', 'Last Login'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_online', 'Online'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_ban_status', 'Ban Status'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_gm_level', 'GM Level'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_characters', 'Characters'); ?>
                                                    </th>
                                                    <th><?php echo translate('admin_users_table_action', 'Action'); ?>
                                                    </th>
                                                </tr>
                                                ...
                                                <?php else: ?>
                                                    <?php foreach ($accounts as $account): ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars($account['email'] ?? translate('admin_users_email_not_set', 'Not set')); ?>
                                                            </td>
                                                            <td><?php echo $account['joindate'] ? date('M j, Y H:i', strtotime($account['joindate'])) : translate('admin_users_na', 'N/A'); ?>
                                                            </td>
                                                            <td><?php echo $account['last_login'] ? date('M j, Y H:i', strtotime($account['last_login'])) : translate('admin_users_never', 'Never'); ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <?php if (!empty($account['characters'])): ?>
                                                                    <button class="btn btn-primary btn-sm" type="button"
                                                                        ...
                                                                        data-bs-target="#characters-<?php echo $account['id']; ?>"
                                                                        aria-expanded="false"
                                                                        aria-controls="characters-<?php echo $account['id']; ?>">
                                                                        <?php echo translate('admin_users_show_characters_button', 'Show Characters') . ' (' . count($account['characters']) . ')'; ?>
                                                                    </button>
                                                                    <div class="collapse character-collapse"
                                                                        id="characters-<?php echo $account['id']; ?>">
                                                                        <div class="character-grid">
                                                                            <?php foreach ($account['characters'] as $char): ?>
                                                                                <div class="character-item">
                                                                                    ...
                                                                                    (<?php echo translate('admin_users_level_prefix', 'Lv') . ' ' . $char['level']; ?>)
                                                                                </div>
                                                                            <?php endforeach; ?>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-manage" data-bs-toggle="modal"
                                                                    data-bs-target="#manageModal-<?php echo $account['id']; ?>"><?php echo translate('admin_users_manage_button', 'Manage'); ?></button>
                                                            </td>
                                                        </tr>
                                                        <!-- Manage Account Modal -->
                                                        <div class="modal fade" id="manageModal-<?php echo $account['id']; ?>"
                                                            tabindex="-1"
                                                            aria-labelledby="manageModalLabel-<?php echo $account['id']; ?>"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="manageModalLabel-<?php echo $account['id']; ?>">
                                                                            <?php echo translate('admin_users_manage_modal_title', 'Manage Account: ') . htmlspecialchars($account['username']); ?>
                                                                        </h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="<?php echo translate('admin_users_close_button', 'Close'); ?>"></button>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="POST"
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    class="form-label"><?php echo translate('admin_users_label_action', 'Action'); ?></label>
                                                                                <select name="ban_action" class="form-select"
                                                                                    id="banAction-<?php echo $account['id']; ?>">
                                                                                    <option value="change_gm_role">
                                                                                        <?php echo translate('admin_users_action_change_gm_role', 'Change GM Role'); ?>
                                                                                    </option>
                                                                                    <option value="ban">
                                                                                        <?php echo translate('admin_users_action_ban', 'Ban Account'); ?>
                                                                                    </option>
                                                                                    <?php if (!empty($account['banInfo'])): ?>
                                                                                        <option value="unban">
                                                                                            <?php echo translate('admin_users_action_unban', 'Unban Account'); ?>
                                                                                        </option>
                                                                                    <?php endif; ?>
                                                                                </select>
                                                                            </div>
                                                                            <div id="banFields-<?php echo $account['id']; ?>"
                                                                                style="display: none;">
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        class="form-label"><?php echo translate('admin_users_label_ban_reason', 'Ban Reason'); ?></label>
                                                                                    <input type="text" name="ban_reason"
                                                                                        class="form-control"
                                                                                        placeholder="<?php echo translate('admin_users_ban_reason_placeholder', 'Enter ban reason'); ?>">
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        class="form-label"><?php echo translate('admin_users_label_ban_duration', 'Ban Duration'); ?></label>
                                                                                    <select name="ban_duration"
                                                                                        class="form-select">
                                                                                        <option value="3600">
                                                                                            <?php echo translate('admin_users_ban_duration_1hour', '1 Hour'); ?>
                                                                                        </option>
                                                                                        <option value="86400">
                                                                                            <?php echo translate('admin_users_ban_duration_1day', '1 Day'); ?>
                                                                                        </option>
                                                                                        <option value="604800">
                                                                                            <?php echo translate('admin_users_ban_duration_7days', '7 Days'); ?>
                                                                                        </option>
                                                                                        <option value="2592000">
                                                                                            <?php echo translate('admin_users_ban_duration_30days', '30 Days'); ?>
                                                                                        </option>
                                                                                        <option value="permanent">
                                                                                            <?php echo translate('admin_users_ban_duration_permanent', 'Permanent'); ?>
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            <div id="gmFields-<?php echo $account['id']; ?>"
                                                                                style="display: block;">
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        class="form-label"><?php echo translate('admin_users_label_gm_level', 'GM Level'); ?></label>
                                                                                    <select name="gmlevel" class="form-select">
                                                                                        <option value="player" <?php echo is_null($account['gmlevel']) ? 'selected' : ''; ?>>
                                                                                            <?php echo translate('admin_users_gmlevel_player', 'Player'); ?>
                                                                                        </option>
                                                                                        <option value="1" <?php echo $account['gmlevel'] === 1 ? 'selected' : ''; ?>>
                                                                                            <?php echo translate('admin_users_gmlevel_1', 'GM Level 1'); ?>
                                                                                        </option>
                                                                                        <option value="2" <?php echo $account['gmlevel'] === 2 ? 'selected' : ''; ?>>
                                                                                            <?php echo translate('admin_users_gmlevel_2', 'GM Level 2'); ?>
                                                                                        </option>
                                                                                        <option value="3" <?php echo $account['gmlevel'] === 3 ? 'selected' : ''; ?>>
                                                                                            <?php echo translate('admin_users_gmlevel_3', 'GM Level 3'); ?>
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary"
                                                                                    data-bs-dismiss="modal"><?php echo translate('admin_users_cancel_button', 'Cancel'); ?></button>
                                                                                <button type="submit"
                                                                                    class="btn btn-primary"><?php echo translate('admin_users_apply_button', 'Apply'); ?></button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                    ...
                                    <?php if ($total_ingame_pages > 1): ?>
                                        <div class="pagination-label">
                                            <?php echo translate('admin_users_ingame_pagination_label', 'In-Game Accounts Pagination'); ?>
                                        </div>
                                        <nav
                                            aria-label="<?php echo translate('admin_users_ingame_pagination_aria', 'In-game accounts pagination'); ?>">
                                            <ul class="pagination">
                                                <li class="page-item <?php echo $ingame_page <= 1 ? 'disabled' : ''; ?>">
                                                    <a class="page-link"
                                                        href="<?php echo $base_path; ?>admin/users?<?php echo ($search_username ? 'search_username=' . urlencode($search_username) . '&' : '') . ($search_email ? 'search_email=' . urlencode($search_email) . '&' : '') . ($role_filter ? 'role_filter=' . urlencode($role_filter) . '&' : '') . ($ban_filter ? 'ban_filter=' . urlencode($ban_filter) . '&' : '') . ($gmlevel_filter ? 'gmlevel_filter=' . urlencode($gmlevel_filter) . '&' : '') . ($sort_id ? 'sort_id=' . urlencode($sort_id) . '&' : '') . 'ingame_page=' . ($ingame_page - 1) . '&website_page=' . $website_page; ?>"
                                                        aria-label="<?php echo translate('admin_users_previous', 'Previous'); ?>">
                                                        <span aria-hidden="true">&laquo;</span>
                                                    </a>
                                                </li>
                                                ...
                                                <?php endfor; ?>
                                                <li
                                                    class="page-item <?php echo $ingame_page >= $total_ingame_pages ? 'disabled' : ''; ?>">
                                                    <a class="page-link"
                                                        href="<?php echo $base_path; ?>admin/users?<?php echo ($search_username ? 'search_username=' . urlencode($search_username) . '&' : '') . ($search_email ? 'search_email=' . urlencode($search_email) . '&' : '') . ($role_filter ? 'role_filter=' . urlencode($role_filter) . '&' : '') . ($ban_filter ? 'ban_filter=' . urlencode($ban_filter) . '&' : '') . ($gmlevel_filter ? 'gmlevel_filter=' . urlencode($gmlevel_filter) . '&' : '') . ($sort_id ? 'sort_id=' . urlencode($sort_id) . '&' : '') . 'ingame_page=' . ($ingame_page + 1) . '&website_page=' . $website_page; ?>"
                                                        aria-label="<?php echo translate('admin_users_next', 'Next'); ?>">
                                                        <span aria-hidden="true">&raquo;</span>
