...
<head>
    ...
    <meta name="description"
        content="<?php echo translate('admin_shop_meta_description', 'Shop Management for Sahtout WoW Server'); ?>">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">
                                <?php echo translate('admin_shop_add_edit_header', 'Add/Edit Shop Item'); ?></h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" class="mb-4" id="itemForm" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="category"
                                            class="form-label required-field"><?php echo translate('admin_shop_label_category', 'Category'); ?></label>
                                        <select name="category" id="category" class="form-select" required>
                                            <option value="Mount">
                                                <?php echo translate('admin_shop_category_mount', 'Mount'); ?></option>
                                            <option value="Pet">
                                                <?php echo translate('admin_shop_category_pet', 'Pet'); ?></option>
                                            <option value="Gold">
                                                <?php echo translate('admin_shop_category_gold', 'Gold'); ?></option>
                                            <option value="Service">
                                                <?php echo translate('admin_shop_category_service', 'Service'); ?>
                                            </option>
                                            <option value="Stuff">
                                                <?php echo translate('admin_shop_category_stuff', 'Stuff'); ?></option>
                                        </select>
                                    </div>

                                    <div class="col-md-4 form-group name-group active">
                                        <label for="name"
                                            class="form-label required-field"><?php echo translate('admin_shop_label_name', 'Name'); ?></label>
                                        <input type="text" name="name" id="name" class="form-control" required
                                            maxlength="100"
                                            placeholder="<?php echo translate('admin_shop_placeholder_name', 'Enter item name'); ?>">
                                    </div>

                                    <div class="col-md-4 form-group point-cost-group active">
                                        <label for="point_cost"
                                            class="form-label required-field"><?php echo translate('admin_shop_label_point_cost', 'Point Cost'); ?></label>
                                        <input type="number" name="point_cost" id="point_cost" class="form-control"
                                            min="0" required
                                            placeholder="<?php echo translate('admin_shop_placeholder_point_cost', 'Enter point cost'); ?>">
                                    </div>

                                    <div class="col-md-4 form-group token-cost-group active">
                                        <label for="token_cost"
                                            class="form-label required-field"><?php echo translate('admin_shop_label_token_cost', 'Token Cost'); ?></label>
                                        <input type="number" name="token_cost" id="token_cost" class="form-control"
                                            min="0" required
                                            placeholder="<?php echo translate('admin_shop_placeholder_token_cost', 'Enter token cost'); ?>">
                                    </div>

                                    <div class="col-md-4 form-group stock-group active">
                                        <label for="stock"
                                            class="form-label"><?php echo translate('admin_shop_label_stock', 'Stock'); ?></label>
                                        <input type="number" name="stock" id="stock" class="form-control" min="0"
                                            placeholder="<?php echo translate('admin_shop_placeholder_stock', 'Leave empty for unlimited'); ?>">
                                    </div>

                                    <div class="col-md-4 form-group entry-group">
                                        <label for="entry"
                                            class="form-label"><?php echo translate('admin_shop_label_entry', 'Item Entry'); ?></label>
                                        <select name="entry" id="entry" class="form-select">
                                            <option value="">
                                                <?php echo translate('admin_shop_select_entry', 'Select Entry'); ?>
                                            </option>
                                    ...
                                    <div class="col-md-4 form-group gold-amount-group">
                                        <label for="gold_amount"
                                            class="form-label"><?php echo translate('admin_shop_label_gold_amount', 'Gold Amount'); ?></label>
                                        <input type="number" name="gold_amount" id="gold_amount" class="form-control"
                                            min="0" value="0"
                                            placeholder="<?php echo translate('admin_shop_placeholder_gold_amount', 'Enter gold amount'); ?>">
                                    </div>

                                    <div class="col-md-4 form-group level-boost-group">
                                        <label for="level_boost"
                                            class="form-label"><?php echo translate('admin_shop_label_level_boost', 'Level Boost (2-255)'); ?></label>
                                        <input type="number" name="level_boost" id="level_boost" class="form-control"
                                            min="2" max="255"
                                            placeholder="<?php echo translate('admin_shop_placeholder_level_boost', 'Enter level boost'); ?>">
                                    </div>

                                    <div class="col-md-4 form-group at-login-flags-group">
                                        <label for="at_login_flags"
                                            class="form-label"><?php echo translate('admin_shop_label_at_login_flags', 'Login Flags'); ?></label>
                                        <select name="at_login_flags" id="at_login_flags" class="form-select">
                                            <option value="0">
                                                <?php echo translate('admin_shop_at_login_none', 'None'); ?></option>
                                            <option value="1">
                                                <?php echo translate('admin_shop_at_login_force_name', 'Force character to change name'); ?>
                                            </option>
                                            <option value="2">
                                                <?php echo translate('admin_shop_at_login_reset_spells', 'Reset spells (professions as well)'); ?>
                                            </option>
                                            <option value="4">
                                                <?php echo translate('admin_shop_at_login_reset_talents', 'Reset Talents'); ?>
                                            </option>
                                            <option value="8">
                                                <?php echo translate('admin_shop_at_login_customize', 'Customize Character'); ?>
                                            </option>
                                            <option value="16">
                                                <?php echo translate('admin_shop_at_login_reset_pet', 'Reset Pet Talents'); ?>
                                            </option>
                                            <option value="32">
                                                <?php echo translate('admin_shop_at_login_first_login', 'First Login'); ?>
                                            </option>
                                            <option value="64">
                                                <?php echo translate('admin_shop_at_login_faction_change', 'Faction Change'); ?>
                                            </option>
                                            <option value="128">
                                                <?php echo translate('admin_shop_at_login_race_change', 'Race Change'); ?>
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group is-item-group">
                                        <label for="is_item"
                                            class="form-label"><?php echo translate('admin_shop_label_is_item', 'Is Item?'); ?></label>
                                    ...
                                    <div class="col-md-8 form-group image-group active">
                                        ...
                                        <small
                                            class="form-text text-muted"><?php echo translate('admin_shop_image_help', 'Leave blank to keep existing image when editing.'); ?></small>
                                        <img id="image_preview" class="image-preview" src=""
                                            alt="<?php echo translate('admin_shop_image_preview_alt', 'Image Preview'); ?>">
                                    </div>

                                    <div class="col-12 form-group description-group">
                                        <label for="description"
                                            class="form-label"><?php echo translate('admin_shop_label_description', 'Description'); ?></label>
                                        <textarea name="description" id="description" class="form-control" rows="4"
                                            placeholder="<?php echo translate('admin_shop_placeholder_description', 'Enter description'); ?>"></textarea>
                                    </div>

                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary"
                                            id="submitBtn"><?php echo translate('admin_shop_add_button', 'Add Item'); ?></button>
                                        <button type="button" id="cancelEdit" class="btn btn-secondary"
                                            style="display:none;"><?php echo translate('admin_shop_cancel_button', 'Cancel'); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" class="filter-search-form mb-4"
                                action="<?php echo $base_path; ?>admin/ashop">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="category_filter"
                                            class="form-label"><?php echo translate('admin_shop_label_category_filter', 'Filter by Category'); ?></label>
                                        <select name="category" id="category_filter" class="form-select">
                                            <option value="">
                                                <?php echo translate('admin_shop_all_categories', 'All Categories'); ?>
                                            </option>
                                    ...
                                    <div class="col-md-4">
                                        <label for="search"
                                            class="form-label"><?php echo translate('admin_shop_label_search', 'Search by Name'); ?></label>
                                        <input type="text" name="search" id="search" class="form-control"
                                            value="<?php echo htmlspecialchars($search_query); ?>"
                                            placeholder="<?php echo translate('admin_shop_placeholder_search', 'Enter item name'); ?>">
                                    </div>
                                    <div class="col-md-4 d-flex align-items-end">
                                        <button type="submit"
                                            class="btn btn-primary w-100"><?php echo translate('admin_shop_apply_button', 'Apply'); ?></button>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <?php if (empty($items)): ?>
                                            <tr>
                                                <td colspan="8" class="text-center">
                                                    <?php echo translate('admin_shop_no_items', 'No items found'); ?></td>
                                            </tr>
                                        <?php else: ?>
                                            <?php foreach ($items as $row): ?>
                                                <tr>
                                                    <td><?php echo $row['item_id']; ?></td>
                                                    <td><?php echo translate('admin_shop_category_' . strtolower($row['category']), $row['category']); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo htmlspecialchars($row['name']); ?>
                                                        <?php if (!empty($row['entry_name'])): ?>
                                                            <br><small
                                                                class="text-muted"><?php echo translate('admin_shop_item_label', 'Item:') . ' ' . htmlspecialchars($row['entry_name']); ?></small>
                                                        <?php elseif ($row['gold_amount'] > 0): ?>
                                                            <br><small
                                                                class="text-muted"><?php echo translate('admin_shop_gold_label', 'Gold:') . ' ' . number_format($row['gold_amount']); ?></small>
                                                        <?php elseif ($row['level_boost']): ?>
                                                            <br><small
                                                                class="text-muted"><?php echo translate('admin_shop_level_label', 'Level:') . ' +' . $row['level_boost']; ?></small>
                                                        <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php if ($row['image']): ?>
                                                            <img src="<?php echo htmlspecialchars($row['image']); ?>"
                                                                alt="<?php echo translate('admin_shop_image_alt', 'Item Image'); ?>"
                                ...
                                <nav aria-label="<?php echo translate('admin_shop_pagination_aria', 'Page navigation'); ?>">
                                    <ul class="pagination">
                                        <li class="page-item <?php echo $page <= 1 ? 'disabled' : ''; ?>">
                                            <a class="page-link"
                                                href="<?php echo $base_path; ?>admin/ashop?page=<?php echo $page - 1; ?><?php echo $category_filter ? '&category=' . urlencode($category_filter) : ''; ?><?php echo $search_query ? '&search=' . urlencode($search_query) : ''; ?>"
                                                aria-label="<?php echo translate('admin_shop_previous', 'Previous'); ?>">
                                        ...
                                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                            <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>">
                                                <a class="page-link"
                                                    href="<?php echo $base_path; ?>admin/ashop?page=<?php echo $i; ?><?php echo $category_filter ? '&category=' . urlencode($category_filter) : ''; ?><?php echo $search_query ? '&search=' . urlencode($search_query) : ''; ?>"><?php echo $i; ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <li class="page-item <?php echo $page >= $total_pages ? 'disabled' : ''; ?>">
                                            <a class="page-link"
                                                href="<?php echo $base_path; ?>admin/ashop?page=<?php echo $page + 1; ?><?php echo $category_filter ? '&category=' . urlencode($category_filter) : ''; ?><?php echo $search_query ? '&search=' . urlencode($search_query) : ''; ?>"
                                                aria-label="<?php echo translate('admin_shop_next', 'Next'); ?>">
